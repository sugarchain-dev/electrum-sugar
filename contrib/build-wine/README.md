...
3. Build Windows binaries
    ...
    $ FRESH_CLONE=contrib/build-wine/fresh_clone && \
        ...
        mkdir -p $FRESH_CLONE && \
        cd $FRESH_CLONE  && \
        git clone https://github.com/sugarchain-project/electrum-sugar.git && \
        cd electrum-sugar
    ```
    ...
    $ sudo docker run -it \
        ...
        -v $PWD:/opt/wine64/drive_c/electrum-sugar \
        --rm \
        --workdir /opt/wine64/drive_c/electrum-sugar/contrib/build-wine \
