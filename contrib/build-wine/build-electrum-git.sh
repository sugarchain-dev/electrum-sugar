...
pushd $WINEPREFIX/drive_c/electrum-sugar
...
for i in ./locale/*; do
    dir=$WINEPREFIX/drive_c/electrum-sugar/electrum/$i/LC_MESSAGES
    mkdir -p $dir
...
cd dist
mv electrum-sugar-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
