...
class UpdateCheck(QWidget, Logger):
    url = "https://raw.githubusercontent.com/sugarchain-dev/sugarchain-dev.github.io/master/version"
    download_url = "https://sugarchain-dev.github.io"

    VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "SiMacNST1rgdnNvwL93b7aK4JGAcBpVyfZ",
    )

    def __init__(self, main_window, latest_version=None):
        self.main_window = main_window
        QWidget.__init__(self)
        self.setWindowTitle('Electrum for Sugarchain - ' + _('Update Check'))
